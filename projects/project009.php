...
<body>
	...
	<div class="container-fluid">
		<div class="jumbotron bg-transparent">
			<h1 class="titularOne text-center text-danger">Buscando Usuarios En Servidor (GET - PHP)</h1>
		</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-6">
					...
					<div id="info" class="alert alert-success titularOne text-justify" role='alert'></div>
				</div>
			</div>
		</div>
	</div>
		...
		$(document).ready(function() {
			...
			$("#txt_name").keyup(function() {
				...
				if (nombre.length == 0) {
					...
					xmlhttp.open("GET", "../ajax/project009.php?nombre=" + nombre, true);
					xmlhttp.send();
				}
			});
		});
